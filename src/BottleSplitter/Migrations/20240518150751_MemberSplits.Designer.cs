...
namespace BottleSplitter.Migrations
{
    ...
    [Migration("20240518150751_MemberSplits")]
    partial class MemberSplits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BottleSplitSplitterUser", b =>
                {
                    b.Property<Guid>("MembersId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SplitsId")
                        .HasColumnType("uuid");

                    b.HasKey("MembersId", "SplitsId");

                    b.HasIndex("SplitsId");

                    b.ToTable("BottleSplitSplitterUser");
                });
            ...
            modelBuilder.Entity("BottleSplitSplitterUser", b =>
                {
                    b.HasOne("BottleSplitter.Model.SplitterUser", null)
                        .WithMany()
                        .HasForeignKey("MembersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BottleSplitter.Model.BottleSplit", null)
                        .WithMany()
